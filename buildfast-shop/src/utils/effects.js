export const EFFECT_OPTIONS = [
  ...
  {
    value: 'underlineSweep',
    label: '〰️ Underline Sweep',
    description: 'Accent underline on hover',
  },
  ...
  { value: 'ripple', label: '💧 Ripple Highlight', description: 'Center-out ripple glow' },
  {
    ...
    description: 'Card tilts toward pointer',
  },
  {
    value: 'parallaxLayers',
    label: '🪄 Parallax Layers',
    description: 'Foreground & background move at different speeds',
  },
  {
    value: 'captionSlide',
    label: '📝 Caption Slide-Up',
    description: 'Details panel glides in from bottom',
  },
  {
    value: 'shadowShift',
    label: '🕶️ Shadow Shift',
    description: 'Dramatic shadow pivots to mimic moving light',
  },
  {
    value: 'neonFrame',
    label: '💡 Neon Frame',
    description: 'Glowing outline traces around the card',
  },
  {
    value: 'contentReveal',
    label: '📬 Content Reveal',
    description: 'Hidden text fades and slides into view',
  },
  {
    value: 'imageZoomOverlay',
    label: '🔍 Image Zoom + Overlay',
    description: 'Background zoom with translucent overlay',
  },
  { value: 'borderRun', label: '🏃 Border Run', description: 'Accent line races along the border' },
  {
    value: 'backgroundSwap',
    label: '🖼️ Background Swap',
    description: 'Alternate artwork crossfades in',
  },
  {
    value: 'staggeredText',
    label: '📚 Staggered Text',
    description: 'Card copy animates line by line',
  },
]
