...
export function parseEffects(effectValue: string | string[] | null | undefined, fallback?: string): string[];
export function parseEffectVariants(rawVariants: string | string[] | null | undefined, fallbackBase?: string[]): string[][];
