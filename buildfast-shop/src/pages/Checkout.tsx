    ...
    >
        ...
        {(user || continueAsGuest) && (
          ...
          <div className="flex-1">
            ...
            {(useManualAddress || !user || savedAddresses.length === 0) && (
              ...
              <form onSubmit={handlePlaceOrder} className="space-y-4 relative z-10 pointer-events-auto">
                {/* Full Name */}
                <div>
      ...
      {hookShowConversionModal && hookGuestCheckoutData && (
        <GuestAccountConversionModal
          ...
          guestEmail={hookGuestCheckoutData.email}
          orderId={hookGuestCheckoutData.orderId}
          guestSessionId={hookGuestCheckoutData.guestSessionId}
        />
      )}
    </>
  )
