...
const AdminReservationSettings = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div data-animate="fade-scale" data-animate-active="false" className="text-center space-y-3">
  ...
  return (
    <div ref={containerRef} data-animate="fade-scale" data-animate-active="false" className="admin-page w-full bg-[var(--bg-main)] px-6 py-10 text-[var(--text-main)]">
      ...
      <form onSubmit={handleSaveSettings} className="space-y-6">
        ...
        <div data-animate="fade-scale" data-animate-active="false" className="glow-surface rounded-xl border border-theme bg-[rgba(255,255,255,0.03)] p-6">
        ...
        <div data-animate="fade-scale" data-animate-active="false" className="glow-surface rounded-xl border border-theme bg-[rgba(255,255,255,0.03)] p-6">
          ...
          <textarea
            ...
            onChange={(e) =>
              setFormData({ ...formData, special_notice: e.target.value })
            }
            rows={3}
