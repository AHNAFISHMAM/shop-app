...
function CropOverlay({ uploadedImage, cropArea, imageRef, onMouseDown, onResizeMouseDown }) {
      ...
      <div className="mx-auto max-w-[1800px] px-4 sm:px-6 md:px-8 lg:px-12 py-6 sm:py-8 md:py-10 lg:py-12">
        ...
        {showAddForm && !editingItem && (
          <>
            ...
            <form onSubmit={handleAddItem} className="mb-8 sm:mb-10 md:mb-12 space-y-6 sm:space-y-8">
            ...
            >
              ...
              >
                ...
                <div className="p-6 sm:p-8 md:p-10 lg:p-12">
                  <form onSubmit={handleUpdateItem} className="space-y-6 sm:space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8">
                      {/* Category */}
                      <div className="space-y-2">
                        <label className="block text-sm sm:text-base font-semibold text-[var(--text-main)] mb-3">
