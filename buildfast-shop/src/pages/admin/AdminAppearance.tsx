      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-sm sm:text-base text-muted max-w-2xl">
                Customize the visual appearance of your website including page backgrounds, colors,
                and theme-specific designs.
              </p>
            </div>
            <button
        ...
        <section className="space-y-6">
          <div className="bg-theme-elevated rounded-xl border border-theme p-6 shadow-md">
            <h2 className="text-xl font-semibold text-[var(--text-main)] mb-2">Page Backgrounds</h2>
            <p className="text-sm text-muted mb-6">
              Configure background images, colors, and gradients for different pages. Set unique
              backgrounds for light and dark themes.
            </p>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="grid gap-6 lg:grid-cols-2">
                  ...
                  <div className="bg-[var(--bg-main)] rounded-xl border border-theme p-5 space-y-4">
                    ...
                    <BackgroundManager section="reservation_dark" label="Reservations (Dark)" />
                  </div>
                  ...
                  <div className="bg-[var(--bg-main)] rounded-xl border border-theme p-5 space-y-4">
                    ...
                    <BackgroundManager section="reservation_light" label="Reservations (Light)" />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-[var(--bg-main)] rounded-xl border border-theme p-5 space-y-4">
                  ...
                  <BackgroundManager section="gallery_section" label="Gallery Section" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[var(--accent)]/10 border border-[var(--accent)]/30 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-muted">
            <li className="flex items-start gap-2">
              ...
              <span>
                Set different backgrounds for light and dark themes to ensure your design looks
                great in both modes
              </span>
            </li>
            <li className="flex items-start gap-2">
            ...
            <li className="flex items-start gap-2">
              <span className="text-[var(--accent)] mt-0.5">•</span>
              <span>
                For images, use high-quality photos with at least 1920px width for best results
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-[var(--accent)] mt-0.5">•</span>
              <span>
                Solid colors and gradients load faster than images and are great for performance
              </span>
            </li>
          </ul>
        </div>
