...
export default function AdminMenuItems() {
  ...
  function validateDietaryTags(dietaryTags: unknown) {
  ...
  if (loading) {
    return (
      <div className="h-full min-h-[400px] bg-[var(--bg-main)] text-[var(--text-main)] flex items-center justify-center">
        <div className="text-center" data-animate="fade-scale" data-animate-active="false">
            ...
            <div className="flex items-start justify-between flex-col sm:flex-row gap-4">
              <div className="flex-1">
                ...
                <p className="text-base sm:text-lg text-[var(--text-muted)] max-w-2xl leading-relaxed">
                  Manage your Star Café menu items with powerful image controls and real-time
                  updates
                </p>
              </div>
              ...
              <div className="flex-shrink-0">
                ...
                >
                  <span className="text-[#C59D5F] font-bold text-lg sm:text-xl">
                  ...
                  createPortal(
                    <>
                      ...
                      {(() => {
                        ...
                        const allOptions = [{ id: 'all', name: 'All Categories' }, ...categories]
                          ...
                          >
                            ...
                            {allOptions.length > maxVisibleItems && (
                              <div className="absolute bottom-0 left-0 right-0 h-12 bg-gradient-to-t from-[var(--bg-main)] via-[var(--bg-main)]/80 to-transparent pointer-events-none flex flex-col items-center justify-end pb-2">
                                <span className="text-[10px] text-[rgba(197,157,95,0.7)] font-medium mb-1">
                                  Scroll for more
                                </span>
                                <svg
                                  className="w-5 h-5 text-[rgba(197,157,95,0.8)] animate-bounce"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                  strokeWidth={2.5}
        ...
        {showAddForm && !editingItem && (
          <>
            ...
            <form
              ...
              className="mb-8 sm:mb-10 md:mb-12 space-y-6 sm:space-y-8 relative z-10 pointer-events-auto"
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative" ref={formCategoryDropdownRef}>
                    ...
                    >
                      ...
                      <svg
                        className={`w-5 h-5 transition-transform duration-300 ${showFormCategoryDropdown ? 'rotate-180' : ''}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
              ...
              <div className="space-y-2">
                ...
                <div className="relative" ref={formSpiceDropdownRef}>
                  <button
                    ...
                    className={`w-full px-5 py-3.5 sm:py-4 min-h-[52px] bg-[rgba(255,255,255,0.05)] border-2 border-[rgba(197,157,95,0.2)] hover:border-[rgba(197,157,95,0.5)] focus:border-[rgba(197,157,95,0.8)] focus:outline-none rounded-lg text-sm sm:text-base text-[var(--text-main)] transition-all duration-300 cursor-pointer backdrop-blur-sm flex items-center justify-between ${
                      formData.spice_level === undefined || formData.spice_level === null
                        ? 'text-[var(--text-muted)]'
                        : ''
                    }`}
                  ...
                  >
                    <span>
                      {SPICE_LEVELS.find(l => l.value === formData.spice_level)?.label ||
                        'Select spice level...'}
                    </span>
                    <svg
                      className={`w-5 h-5 transition-transform duration-300 ${showFormSpiceDropdown ? 'rotate-180' : ''}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 p-5 sm:p-6 rounded-lg bg-[rgba(255,255,255,0.03)] border-0">
                {[
                  ...
                  <label key={toggle.name} className="flex items-center gap-3 cursor-pointer group">
                    ...
                    />
                    <span className="text-sm sm:text-base text-[var(--text-main)] group-hover:text-[#C59D5F] transition-colors">
                      {toggle.label}
                    </span>
                  </label>
                ))}
                ...
                >
                  ...
                  <div className="sticky top-0 z-10 flex items-center justify-between p-6 sm:p-8 border-b border-[rgba(197,157,95,0.2)] bg-[var(--bg-main)]">
                    <div>
                      <h2
                        ...
                        className="text-2xl sm:text-3xl md:text-4xl font-bold text-[var(--text-main)] mb-2"
                      >
                        Edit Menu Item
                      </h2>
                  ...
                  <div className="p-6 sm:p-8 md:p-10 lg:p-12">
                    <form
                      ...
                      className="space-y-6 sm:space-y-8 relative z-10 pointer-events-auto"
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 md:gap-8">
                        {/* Category */}
                        <div className="space-y-2">
                          ...
                          <div className="relative" ref={editFormCategoryDropdownRef}>
                            <button
                              type="button"
                              onClick={() =>
                                setShowEditFormCategoryDropdown(!showEditFormCategoryDropdown)
                              }
                              className={`w-full px-5 py-3.5 sm:py-4 min-h-[52px] bg-[rgba(255,255,255,0.05)] border-2 border-[rgba(197,157,95,0.2)] hover:border-[rgba(197,157,95,0.5)] focus:border-[rgba(197,157,95,0.8)] focus:outline-none rounded-lg text-sm sm:text-base text-[var(--text-main)] transition-all duration-300 cursor-pointer backdrop-blur-sm flex items-center justify-between ${
                                !formData.category_id ? 'text-[var(--text-muted)]' : ''
                              }`}
                            ...
                            >
                              ...
                              <svg
                                className={`w-5 h-5 transition-transform duration-300 ${showEditFormCategoryDropdown ? 'rotate-180' : ''}`}
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                              >
                        ...
                        {!uploadedImage ? (
                          <div className="space-y-3">
                            <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-[rgba(197,157,95,0.3)] rounded-xl bg-[rgba(255,255,255,0.02)] hover:border-[rgba(197,157,95,0.5)] cursor-pointer transition-all duration-300">
                              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                <svg
                                  className="w-10 h-10 mb-3 text-[rgba(197,157,95,0.6)]"
                                  fill="none"
                                  stroke="currentColor"
                                  viewBox="0 0 24 24"
                                >
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-3">
                              ...
                              <div
                                className="relative border-2 border-[rgba(197,157,95,0.4)] rounded-lg overflow-hidden bg-black/20"
                            ...
                            <div className="space-y-3">
                              ...
                              <div
                                className="border border-[rgba(197,157,95,0.2)] rounded-xl overflow-hidden bg-[rgba(255,255,255,0.02)]"
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative" ref={editFormSpiceDropdownRef}>
                          ...
                          >
                            ...
                            <svg
                              className={`w-5 h-5 transition-transform duration-300 ${showEditFormSpiceDropdown ? 'rotate-180' : ''}`}
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                            >
                              ...
                              <>
                                ...
                                {(() => {
                                  const dropdownElement =
                                    editFormSpiceDropdownRef.current as HTMLElement | null
                                  const buttonRect = dropdownElement
                                    ?.querySelector('button')
                                    ?.getBoundingClientRect()
                                  if (!buttonRect) return null
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <h2
                        ...
                        className="text-xl sm:text-2xl font-bold text-[var(--text-main)] mb-3"
                      >
                      ...
                      <div className="space-y-2 text-xs sm:text-sm text-[var(--text-muted)]">
                        ...
                        <ul className="space-y-1.5 ml-4 list-disc list-outside">
                          <li>
                            <strong className="text-green-400">Available items</strong> are shown in
                            the first section below. Click the green &quot;Available&quot; button on
                            any item to make it unavailable.
                          </li>
                          <li>
                            <strong className="text-red-400">Unavailable items</strong> are shown in
                            the second section below. Click the gray &quot;Unavailable&quot; button
                            on any item to make it available.
                          </li>
                          <li>
                            <strong className="text-[#C59D5F]">Bulk actions:</strong> Select
                            multiple items using checkboxes, then click &quot;Toggle X Item(s)&quot;
                            to change their availability all at once.
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex items-center justify-between p-3 rounded-lg bg-[rgba(197,157,95,0.1)] border border-[rgba(197,157,95,0.2)]">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {bulkToggleLoading
                            ? 'Updating...'
                            : `Toggle ${selectedItemsForBulk.size} Item(s)`}
                        </button>
                      </div>
                    </div>
                  )}
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          {unavailableItems.length === 0 ? (
                            <div className="text-center py-8 text-sm text-[var(--text-muted)]">
                              {modalSearchTerm
                                ? 'No unavailable items match your search'
