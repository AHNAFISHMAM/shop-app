          ...
          >
            <AuthShell.Card>
              <div className="space-y-5 text-center" role="status" aria-live="polite">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-[var(--status-success-border)] bg-[var(--status-success-bg)]" aria-hidden="true">
                  <svg className="h-8 w-8 text-[var(--color-emerald)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <AuthShell.Root>
        ...
        >
          <AuthShell.Card>
            <AuthShell.Header
              ...
              helper={(
                <span>
                  ...
                  <Link to="/login" className="font-medium text-[var(--accent)] underline underline-offset-4 transition hover:text-[var(--accent)]/80" aria-label="Go to login page">
                    Sign in
                  </Link>
                </span>
              )}
            ...
            <form className="space-y-5 relative z-10 pointer-events-auto" onSubmit={handleSubmit} aria-label="Signup form">
