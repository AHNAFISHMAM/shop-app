...
const ReservationsPage = memo(() => {
  ...
  const handleReservationSubmit = useCallback(async (data: unknown) => {
    setSubmitting(true);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <p
              className="text-sm sm:text-base text-[var(--text-main)] font-light leading-relaxed mb-8"
            >
      ...
      >
        <div className="app-container">
          <h2 id="reservation-info-heading" className="sr-only">Reservation Information</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
            {/* Opening Hours Card */}
            <div
              className="group glow-surface glow-soft relative overflow-hidden rounded-xl sm:rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-default)] px-4 sm:px-6 md:px-10 py-3 sm:py-4 md:py-5 hover:border-[var(--accent)]/30 transition-all duration-300"
            >
              ...
              <div className="relative">
                ...
                <p className="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--accent)] mb-1">
                  {formatTime(reservationSettings?.opening_time || null)} - {formatTime(reservationSettings?.closing_time || null)}
                </p>
            ...
            <div
              className="group glow-surface glow-soft relative overflow-hidden rounded-xl sm:rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-default)] px-4 sm:px-6 md:px-10 py-3 sm:py-4 md:py-5 hover:border-[var(--color-emerald)]/30 transition-all duration-300"
            >
              ...
              <div className="relative">
                ...
                <p className="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--color-emerald)] mb-1">30 min</p>
            ...
            {/* Group Size Card */}
            <div
              className="group glow-surface glow-soft relative overflow-hidden rounded-xl sm:rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-default)] px-4 sm:px-6 md:px-10 py-3 sm:py-4 md:py-5 hover:border-[var(--color-blue)]/30 transition-all duration-300"
            >
            ...
            {/* Book Ahead Card */}
            <div
              className="group glow-surface glow-soft relative overflow-hidden rounded-xl sm:rounded-2xl bg-[var(--bg-elevated)] border border-[var(--border-default)] px-4 sm:px-6 md:px-10 py-3 sm:py-4 md:py-5 hover:border-[var(--color-purple)]/30 transition-all duration-300"
            >
      ...
      >
        <div className="app-container">
          <div className="text-center mb-12">
            <h2 id="policies-heading" className="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--text-main)] mb-4">
              Reservation Policies
            </h2>
            <p className="text-sm text-[var(--text-secondary)]">Everything you need to know before booking</p>
          </div>
          ...
          >
            ...
            <div className="relative space-y-12">
              <div className="text-center space-y-4">
                <h2 id="why-reserve-heading" className="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--text-main)]">
      ...
      >
        <div className="app-container space-y-10">
          <div className="text-center space-y-3">
            <h2 id="faqs-heading" className="text-xl sm:text-2xl md:text-3xl font-bold text-[var(--text-main)]">
              Reservation FAQs
            </h2>
