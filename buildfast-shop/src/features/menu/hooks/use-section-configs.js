...
const DEFAULT_SECTION_CONFIGS = [
  { section_key: 'todays_menu', section_name: "Today's Menu", is_available: true, display_order: 1 },
  { section_key: 'daily_specials', section_name: 'Daily Specials', is_available: true, display_order: 2 },
  { section_key: 'new_dishes', section_name: 'New Dishes', is_available: true, display_order: 3 },
  { section_key: 'discount_combos', section_name: 'Discount Combos', is_available: true, display_order: 4 },
  { section_key: 'limited_time', section_name: 'Limited-Time Meals', is_available: true, display_order: 5 },
  { section_key: 'happy_hour', section_name: 'Happy Hour Offers', is_available: true, display_order: 6 },
];
