 ...
 * @param {string} props.sortBy - Sort by value
 * @param {Function} props.onSortChange - Sort change handler
 * @param {Array} props.categories - Categories list
 * @param {Function} props.onMoreFilters - More filters button handler
 * @param {string} props.minPrice - Minimum price filter
 * @param {string} props.maxPrice - Maximum price filter
 */
...
OrderPageFilters.propTypes = {
  ...
  onMoreFilters: PropTypes.func.isRequired,
