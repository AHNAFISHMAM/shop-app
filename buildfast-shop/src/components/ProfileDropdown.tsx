 ...
 *
 * User profile dropdown menu with navigation links and account actions.
 * Features:
...
const ProfileDropdown = () => {
  ...
  if (loading) {
    return (
      <div
        className="flex items-center justify-center w-10 h-10 min-h-[44px] min-w-[44px] rounded-full border border-[var(--border-default)]"
        style={{
  ...
  if (!user) {
    return (
      <div className="flex items-center gap-3">
        <Link
          to="/login"
          className="text-sm uppercase tracking-wide text-[var(--text-muted)] hover:text-[var(--text-main)] transition-colors min-h-[44px] flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2"
        ...
        <Link
          to="/signup"
          className="text-sm uppercase tracking-wide text-black bg-[var(--accent)] px-4 py-2 min-h-[44px] rounded-full hover:bg-white transition-colors flex items-center focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2"
      ...
      <>
        ...
        <div
          ...
          style={{
            ...
            backgroundColor: isLightTheme
              ? 'rgba(var(--text-main-rgb), 0.7)' // Light theme: white with transparency
              : 'rgba(var(--bg-dark-rgb), 0.7)', // Dark theme: dark with transparency
