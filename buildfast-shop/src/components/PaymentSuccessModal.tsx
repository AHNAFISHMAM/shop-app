...
function PaymentSuccessModal({
  ...
  currencySymbol = '৳',
  onClose,
}: PaymentSuccessModalProps): JSX.Element | null {
  ...
  useEffect(() => {
    if (!isOpen) {
      return undefined // Don't run countdown if modal is closed
    }
          ...
          >
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                <p className="text-[10px] sm:text-xs uppercase tracking-[0.45em] text-[var(--text-main)]/40 mb-3">
                  Payment Confirmed
                </p>
                ...
                <p className="text-sm sm:text-base text-[var(--text-main)]/70 max-w-sm mx-auto">
                  Your payment was processed successfully. We&apos;re preparing everything with
                  care.
                </p>
                {orderId && (
                  <div className="mt-6 rounded-xl sm:rounded-2xl border border-theme bg-theme-elevated px-4 sm:px-6 md:px-10 py-3 sm:py-4 md:py-5 text-left">
                    <p className="text-[10px] sm:text-xs uppercase tracking-wide text-[var(--text-main)]/50">
                      Order ID
                    </p>
              ...
              {orderTotal !== undefined && orderTotal !== null && (
                <div className="mb-8 rounded-xl sm:rounded-2xl border border-theme bg-white/5 px-4 sm:px-6 md:px-10 py-3 sm:py-4 md:py-5">
                  <div className="flex items-center justify-between gap-3 sm:gap-4 md:gap-6">
                    <span className="text-sm sm:text-base text-[var(--text-main)]/60">
                      Order Total
                    </span>
                  ...
                  <div className="mt-3 flex items-start gap-3 sm:gap-4 md:gap-6 text-sm sm:text-base text-[var(--text-main)]/60">
                    ...
                    <span>
                      A confirmation email with your receipt has been sent. Keep an eye out for
                      updates.
                    </span>
                  </div>
                </div>
