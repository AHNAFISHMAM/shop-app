        ...
        >
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4 md:gap-6 flex-1 min-w-0 pr-3">
              <div
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[var(--accent)]/10 flex items-center justify-center flex-shrink-0"
                aria-hidden="true"
              >
                <svg
              ...
              <div className="flex-1 min-w-0">
                <h2
                  ...
                  className="text-base sm:text-lg md:text-xl font-bold text-[var(--text-main)] truncate"
                >
                  Save Your Favorites
                </h2>
                <p
                  id="signup-modal-description"
                  className="text-xs sm:text-sm text-[var(--text-muted)] mt-0.5 hidden sm:block"
                >
          ...
          >
            ...
            <p className="text-sm sm:text-base text-[var(--text-main)] leading-relaxed mb-6">
              Create a free account to save your favorite dishes and quickly reorder your go-to
              meals. It only takes a minute to get started!
            </p>
            ...
            <div className="space-y-3 mb-6 gap-3 sm:gap-4 md:gap-6" role="list">
              <div className="flex items-start gap-3 sm:gap-4 md:gap-6" role="listitem">
                <div
                  className="w-5 h-5 rounded-full bg-[var(--accent)]/20 flex items-center justify-center flex-shrink-0 mt-0.5"
                  aria-hidden="true"
                >
                  <svg
                ...
                <div>
                  <p className="text-sm sm:text-base font-medium text-[var(--text-main)]">
                    Save Favorite Dishes
                  </p>
                  <p className="text-sm text-[var(--text-muted)] mt-0.5">
                    Keep track of meals you love
                  </p>
                </div>
              </div>
