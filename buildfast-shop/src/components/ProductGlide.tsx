 ...
 *
 * @param {ProductGlideProps} props - Component props
 */
const ProductGlide = ({ id }: ProductGlideProps) => {
  ...
  return (
    <section
      id={id}
      className="relative overflow-hidden rounded-[32px] border border-[var(--border-default)] bg-gradient-to-br from-[#0a0c13] via-[#101423] to-[#07080d] px-6 py-14 md:px-12 md:py-20"
      role="region"
            ...
            {PRODUCT_FEATURES.map((feature, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="mt-1 inline-flex h-8 w-8 min-w-[32px] min-h-[32px] items-center justify-center rounded-full border border-[var(--accent)]/40 bg-[var(--accent)]/15 text-sm font-semibold text-[var(--accent)]">
                    {index + 1}
                  </span>
