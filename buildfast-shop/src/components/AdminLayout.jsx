  ...
  return (
    <div className="app-shell">
      ...
      <div className="flex h-[calc(100vh-4rem)] overflow-hidden min-h-0">
        ...
        <aside
          data-overlay-scroll
          className="w-56 border-r flex flex-col sticky top-16 h-[calc(100vh-4rem)] overflow-y-auto flex-shrink-0"
          style={{
          width: '224px',
        ...
        >
          ...
          <div className="p-6 border-b" style={{ borderColor: 'var(--border-default)' }}>
            ...
            <p className="text-xs text-muted mt-1">Restaurant Management</p>
          </div>
                  ...
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `flex items-center px-4 py-3 text-sm font-medium rounded-xl transition-all duration-200 group ${
                        isActive ? 'shadow-lg ring-1 ring-[rgba(197,157,95,0.25)]' : 'text-muted hover:bg-elevated hover:text-[var(--text-main)]'
                      }`
                    }
                    style={({ isActive }) => ({
          ...
          <div className="p-4 border-t space-y-3" style={{ borderColor: 'var(--border-default)' }}>
            ...
            {user?.email && (
              <div className="px-3 py-2 bg-elevated rounded-lg">
                ...
                <p className="text-xs font-medium text-accent truncate" title={user.email}>
                  {user.email}
                </p>
              </div>
            )}
            ...
            <button
              ...
              className="flex items-center justify-center w-full px-4 py-3 text-sm font-semibold rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
              style={{
