...
const CustomerProfileDrawer = ({ customer, onClose }: CustomerProfileDrawerProps): JSX.Element | null => {
  ...
  const insightRows = useMemo((): InsightRow[] => {
    ...
    return [
      ...
      {
        label: 'Last Order',
        value: customer.lastOrderAt ? dateTimeFormatter.format(new Date(customer.lastOrderAt)) : '—'
      },
      {
        label: 'Last Visit',
        value: customer.lastVisitDate ? dateFormatter.format(new Date(customer.lastVisitDate)) : '—'
      },
      {
        label: 'Status',
