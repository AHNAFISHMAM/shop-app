...
export default function ImageUploadModal({ isOpen, onClose, onImageUploaded, dishName }: ImageUploadModalProps): JSX.Element | null {
        ...
        >
          ...
          <div className="flex-1 min-w-0 pr-3">
            ...
            <p className="text-xs sm:text-sm text-[var(--text-muted)] mt-0.5 hidden sm:block">
              Uploading image for: <span className="font-semibold text-[var(--accent)]">{dishName}</span>
            </p>
          </div>
