  ...
  return createPortal(
    ...
    >
      ...
      >
        ...
        <div
          className="flex-1 overflow-y-auto overflow-x-hidden px-4 sm:px-7 pb-8 pt-4 sm:pt-6 md:px-10 scrollbar-thin scrollbar-track-transparent scrollbar-thumb-white/10 hover:scrollbar-thumb-[#C59D5F]/30"
