...
const VARIANTS = {
  default: "bg-[var(--accent)] text-black shadow-sm shadow-black/5 hover:bg-[var(--accent)]/90 focus-visible:ring-[var(--accent)]/50",
  destructive:
  ...
  ghost: "hover:bg-[var(--bg-hover)] hover:text-[var(--text-main)] focus-visible:ring-[var(--accent)]/50",
