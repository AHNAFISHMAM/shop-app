    ...
    return (
      <div className={cn('space-y-2', wrapperClassName)}>
        ...
        <input
          ...
          aria-describedby={showHelperText ? `${finalId}-helper` : undefined}
          ...
          className={cn(
            ...
            // Error state
            hasError &&
              'border-[var(--destructive)] focus:border-[var(--destructive)] focus:ring-[var(--destructive)]/50',
            // Success state
            success &&
              !hasError &&
              'border-[var(--status-success-border)] focus:border-[var(--status-success-border)] focus:ring-[var(--status-success-border)]/50',
            // Shadow
