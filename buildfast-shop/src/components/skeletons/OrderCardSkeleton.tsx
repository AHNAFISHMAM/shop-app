...
export function OrderCardSkeleton() {
  return (
    <div className="card-soft space-y-4 animate-pulse p-6" role="status" aria-label="Loading order card">
      {/* Header */}
      <div className="flex justify-between items-start">
        ...
        <div className="h-6 bg-[var(--bg-elevated)] rounded w-20 min-h-[44px] min-w-[44px]" aria-hidden="true" />
      </div>
      ...
      {/* Footer */}
      <div className="flex justify-between pt-4 border-t border-[var(--border-default)]" aria-hidden="true">
