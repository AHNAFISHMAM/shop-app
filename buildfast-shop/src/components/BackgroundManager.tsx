  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 pb-4 border-b border-[var(--border-default)]">
        <div>
          <h3
            id="background-manager-heading"
            className="text-lg sm:text-xl font-semibold text-[var(--text-main)]"
          >
            {label} Background
          </h3>
      ...
      <div className="min-h-[300px]">
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="flex-1">
                  <input
                    ...
                    aria-describedby={
                      config.color && !isValidHexColor(config.color) ? 'color-error' : undefined
                    }
                  />
                  ...
                  <p className="text-xs text-[var(--text-muted)] mt-2">
                    Enter hex color or use the picker above
                  </p>
                </div>
              </div>
            </div>
        ...
        {activeTab === 'gradient' && (
          ...
          >
            <div className="bg-[var(--bg-elevated)] rounded-xl p-4 sm:p-5 border border-[var(--border-default)] shadow-sm">
              <label
                htmlFor="gradient-input"
                className="block text-sm sm:text-base font-semibold mb-3 sm:mb-4 text-[var(--text-main)]"
              >
                CSS Gradient
              </label>
              <textarea
              ...
              {config.gradient && !isValidGradient(config.gradient) && (
                ...
                >
                  ...
                  <p className="text-xs">
                    Invalid gradient format (must contain &quot;gradient(&quot;)
                  </p>
                </div>
              )}
              <p className="text-xs text-[var(--text-muted)] mt-2">
              ...
              >
                {gradientPresets.map(preset => (
                  <button
                    ...
                    style={getPresetPreview(preset) as React.CSSProperties}
                    title={preset.name}
        ...
        {activeTab === 'image' && (
          ...
          >
                ...
                >
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[var(--bg-elevated)] flex items-center justify-center group-hover:bg-[var(--accent)]/10 transition-all duration-200 shadow-md group-hover:shadow-lg">
                    {uploading ? (
                      ...
                      <svg
                        className="w-8 h-8 text-[var(--text-muted)] group-hover:text-[var(--accent)] transition-colors"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl p-4 sm:p-5 border border-[var(--border-default)] shadow-sm">
              <label
                htmlFor={`image-url-input-${section}`}
                className="block text-sm sm:text-base font-semibold mb-3 text-[var(--text-main)]"
              >
                Or Enter Image URL
              </label>
              <input
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] shadow-sm overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-[var(--text-muted)]">
                      {restaurantInteriorImages.length} images
                    </p>
                  </div>
                </div>
                <svg
                  className={`w-5 h-5 text-[var(--text-muted)] transition-transform duration-200 ${expandedCategories.interiors ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
              ...
              {expandedCategories.interiors && (
                <div
                  id="interiors-images"
                  className="p-4 sm:p-5 pt-0 grid grid-cols-1 sm:grid-cols-2 gap-3"
                  role="group"
                  aria-label="Restaurant interior images"
                >
                  {restaurantInteriorImages.map(preset => (
                    ...
                    >
                      <div
                        className={`absolute inset-0 bg-gradient-to-t from-[var(--bg-main)]/80 to-transparent ${prefersReducedMotion ? '' : 'opacity-0 group-hover:opacity-100'} transition-opacity duration-200`}
                      />
                      <div className="absolute bottom-0 left-0 right-0 p-3 bg-[var(--bg-main)]/60 backdrop-blur-sm">
                        <p className="text-[var(--text-main)] text-xs font-semibold">
                          {preset.name}
                        </p>
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-[var(--text-muted)]">
                      {tableSettingsImages.length} images
                    </p>
                  </div>
                </div>
                <svg
                  className={`w-5 h-5 text-[var(--text-muted)] transition-transform duration-200 ${expandedCategories.tableSettings ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
              ...
              {expandedCategories.tableSettings && (
                <div
                  id="table-settings-images"
                  className="p-4 sm:p-5 pt-0 grid grid-cols-1 sm:grid-cols-2 gap-3"
                  role="group"
                  aria-label="Table settings images"
                >
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] shadow-sm overflow-hidden">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-[var(--text-muted)]">
                      {subtleTextureImages.length} images
                    </p>
                  </div>
                </div>
                <svg
                  className={`w-5 h-5 text-[var(--text-muted)] transition-transform duration-200 ${expandedCategories.textures ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
              ...
              {expandedCategories.textures && (
                <div
                  ...
                  className="p-4 sm:p-5 pt-0 grid grid-cols-1 sm:grid-cols-2 gap-3"
                  role="group"
                  aria-label="Subtle texture images"
                >
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] shadow-sm overflow-hidden">
              ...
              >
                ...
                <svg
                  className={`w-5 h-5 text-[var(--text-muted)] transition-transform duration-200 ${expandedCategories.additional ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
          ...
          >
            ...
            <div className="bg-gradient-to-br from-[var(--accent)]/10 via-[var(--accent)]/5 to-transparent rounded-xl sm:rounded-2xl p-5 sm:p-6 border-2 border-[var(--accent)]/30 shadow-lg">
              ...
              <div
                ...
                role="group"
                aria-label="Recommended presets"
              >
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-t from-black/60 to-transparent ${prefersReducedMotion ? '' : 'opacity-0 group-hover:opacity-100'} transition-opacity duration-200`}
                  />
                ...
                <button
                  onClick={() =>
                    handlePresetSelect({
                      gradient:
                        'linear-gradient(to bottom right, #FAF8F5 0%, #F0EDE5 50%, #E8E4DC 100%)',
                    })
                  }
                  className={`group relative h-28 min-h-[44px] rounded-xl border-2 border-[var(--accent)]/40 hover:border-[var(--accent)] transition-all duration-200 ${prefersReducedMotion ? '' : 'hover:scale-105 active:scale-95'} hover:shadow-xl overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2`}
                  style={{
            ...
            <div
              ...
              role="separator"
              aria-label="All presets section"
            >
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] p-4 sm:p-5 shadow-sm">
              ...
              <div
                ...
                role="group"
                aria-label="Solid color presets"
              >
                {solidColorPresets.map(preset => {
                  const isLight = preset.color ? lightColors.includes(preset.color) : false
                  return (
                    <button
                      key={preset.id}
                    ...
                    >
                      <div
                        className={`relative z-10 transition-all duration-200 ${isLight ? 'group-hover:drop-shadow-md' : ''}`}
                      >
                        <p
                          className={`text-xs font-semibold ${isLight ? 'text-gray-900' : 'text-white'}`}
                        >
                          {preset.name}
                        </p>
                        <p
                          className={`text-xs mt-1 ${isLight ? 'text-gray-600' : 'text-[var(--text-main)]/70'}`}
                        >
                          {preset.color}
                        </p>
                      </div>
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] p-4 sm:p-5 shadow-sm">
              ...
              >
                {gradientPresets.map(preset => (
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-t from-black/70 to-transparent ${prefersReducedMotion ? '' : 'opacity-0 group-hover:opacity-100'} transition-opacity duration-200`}
                    />
                    <div className="absolute bottom-0 left-0 right-0 p-3 bg-[var(--bg-main)]/60 backdrop-blur-sm">
            ...
            <div className="bg-[var(--bg-elevated)] rounded-xl border border-[var(--border-default)] p-4 sm:p-5 shadow-sm">
              ...
              <p className="text-xs text-[var(--text-muted)] text-center mt-4">
                Switch to the Image tab to see all {imagePresets.length} curated images organized by
                category
              </p>
            </div>
          </div>
      ...
      <div className="bg-[var(--bg-elevated)] rounded-xl p-4 sm:p-5 border border-[var(--border-default)] shadow-sm">
        ...
        >
          <div className="text-center px-6 py-4 rounded-xl bg-[var(--bg-main)]/60 backdrop-blur-md shadow-2xl">
            <p className="text-white font-semibold text-sm sm:text-base mb-1">{label}</p>
