...
export const resolveReferralInfo = (user) => {
  ...
  const origin =
    typeof window !== 'undefined' ? window.location.origin : 'https://star-cafe.app';
  ...
  return {
    ...
    subcopy: 'Each new guest who books with your link unlocks 250 bonus points after their first visit.',
  };
};
