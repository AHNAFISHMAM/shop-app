...
export declare function uploadImage(file: File, path: string, bucket?: string): Promise<{
    success: boolean;
    url: string | null;
    error: string | null;
}>;
export declare function deleteImage(url: string, bucket?: string): Promise<{
    success: boolean;
    error: string | null;
}>;
...
export declare function getCroppedImageUrl(originalUrl: string, cropParams: {
    x: number;
    y: number;
    width: number;
    height: number;
}, targetWidth?: number, targetHeight?: number): string;
export declare function getResizedImageUrl(originalUrl: string, width: number, height?: number): string;
export declare function getOptimizedImageUrl(originalUrl: string, quality?: number, format?: string): string;
export declare function getPlaceholderImage(width?: number, height?: number): string;
export declare function uploadMenuImage(file: File, dishName: string, metadata?: Record<string, any>): Promise<{
    success: boolean;
    url: string | null;
    error: string | null;
    duplicate?: boolean;
