...
export function findCombinationByValues(
  productId: string,
  variantValues: Record<string, string>
): Promise<{ success: boolean; data?: VariantCombination | null; error?: unknown }>
export function getCombinationById(
  combinationId: string
): Promise<{ success: boolean; data?: VariantCombination; error?: unknown }>
...
export function createCombinationSnapshot(combination: VariantCombination | null): {
...
export function createCombination(
  combinationData: Partial<VariantCombination>
): Promise<{ success: boolean; data?: VariantCombination; error?: unknown }>
...
export function generateCombinations(
  variantsByType: Record<string, Array<{ variant_value: string; price_adjustment?: number }>>
): Array<{ variant_values: Record<string, string>; price_adjustment: number }>
